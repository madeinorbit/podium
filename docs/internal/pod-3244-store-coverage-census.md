...
| `apps/server/src/store/user-layout.ts` | UserDockShellRepository | `get` | 222 | yes | `apps/server/src/store/user-dock-shell.test.ts` | `apps/server/src/store/user-dock-shell.test.ts`, `apps/server/src/modules/shells/service.test.ts` |
| `apps/server/src/store/user-layout.ts` | UserDockShellRepository | `listForUser` | 234 | yes | `apps/server/src/store/user-dock-shell.test.ts` | `apps/server/src/store/user-dock-shell.test.ts`, `apps/server/src/modules/shells/service.test.ts` |
| `apps/server/src/store/user-layout.ts` | UserDockShellRepository | `tryClaim` | 252 | yes | `apps/server/src/store/user-dock-shell.test.ts` | `apps/server/src/store/user-dock-shell.test.ts`, `apps/server/src/modules/shells/service.test.ts` |
| `apps/server/src/store/user-layout.ts` | UserDockShellRepository | `set` | 276 | yes | `apps/server/src/store/user-dock-shell.test.ts` | `apps/server/src/store/user-dock-shell.test.ts`, `apps/server/src/modules/shells/service.test.ts` |
| `apps/server/src/store/user-layout.ts` | UserDockShellRepository | `remove` | 294 | yes | `apps/server/src/store/user-dock-shell.test.ts` | `apps/server/src/store/user-dock-shell.test.ts` |
| `apps/server/src/store/user-layout.ts` | UserDockShellRepository | `removeByWorktree` | 308 | yes | `apps/server/src/store/user-dock-shell.test.ts` | `apps/server/src/store/user-dock-shell.test.ts`, `apps/server/src/modules/shells/worktree-free.test.ts` |
| `apps/server/src/store/user-layout.ts` | UserDockShellRepository | `removeBySession` | 321 | yes | `apps/server/src/store/user-dock-shell.test.ts` | `apps/server/src/store/user-dock-shell.test.ts`, `apps/server/src/modules/shells/service.test.ts` |
| `apps/server/src/store/user-layout.ts` | UserDockShellRepository | `worktreeForSession` | 331 | yes | `apps/server/src/store/user-dock-shell.test.ts` | `apps/server/src/store/user-dock-shell.test.ts`, `apps/server/src/modules/shells/worktree-free.test.ts` |
