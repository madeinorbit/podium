...
export P3110_INSTANCE="p3110-grok-paired-057755c"
export P3110_BASE="/tmp/pod-3110-grok-paired-057755c"
...
export PODIUM_PASSWORD="p3110-grok-paired-057755c-proof"
