...
export P3110_INSTANCE="p3110-grok-paired-2ac84c5-r9"
export P3110_BASE="/tmp/pod-3110-grok-paired-2ac84c5-r9"
export P3110_RUN_TOKEN="${P3110_RUN_TOKEN:-$(date -u +%Y%m%dT%H%M%S.%NZ)-$$}"
export P3110_RUN_DIR="$P3110_BASE/runs/$P3110_RUN_TOKEN"
export P3110_PIN="2ac84c5086338d03a8d5bb5fc96a2f2dc3d95303"
...
export PODIUM_PASSWORD="p3110-grok-paired-2ac84c5-r9-proof"
