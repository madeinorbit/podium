#!/usr/bin/env bash
# Bring up the isolated `p2792` instance: server + daemon + web bundle.
#
#   bash docs/evidence/pod-2792/drive-up.sh                            # headless arm
#   P2777_DRIVER=generic-pty bash docs/evidence/pod-2792/drive-up.sh   # terminal arm
#
