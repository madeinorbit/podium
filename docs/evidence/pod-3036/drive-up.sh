...
PIN_SHA="${P3036_PIN_SHA:-c71b896a9504426ee6706a0623e9cb25e704cc98}"
...
HEAD_SHA="$PIN_SHA"
WEB_REUSE_FROM="${P3036_REUSE_WEB_FROM:-/home/mgw/src/podium/.worktrees/issue-1761-agent-runtime}"
mkdir -p "$LOGS"
