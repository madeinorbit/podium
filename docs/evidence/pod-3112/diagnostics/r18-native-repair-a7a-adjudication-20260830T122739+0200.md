...
One eight-field acceptance row was written to the authoritative epic ledger. No `a7a-ready`/`a7a-continue` marker was emitted, and A7b was not attempted. The sibling JSON contains only redacted structural fields and SHA-256 hashes of the raw temporary readings.
