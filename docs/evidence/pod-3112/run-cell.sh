...
git -C "$PODIUM_DRIVE_REPO" add -f docs/evidence/pod-3112/readings docs/evidence/pod-3112/pins docs/evidence/pod-3112/results.tsv docs/plans/pod-1761-results.tsv
