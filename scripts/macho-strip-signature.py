#!/usr/bin/env python3
"""Remove the code signature from a thin 64-bit Mach-O.

Used by scripts/prove-headless-assertions-can-fail.sh to produce a genuinely
unsigned binary, so the release gate's signature checks can be shown to fire.
Came from the POD-2501 spike.
