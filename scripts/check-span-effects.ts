...
const ACCEPTED: readonly AcceptedFinding[] = [
  ...
  {
    key: 'apps/server/src/modules/sessions/session.ts#Send.Send@apps/server/src/modules/sessions/session-meta-ops.ts:386',
