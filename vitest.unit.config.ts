 ...
 * Package-local runs must select the same hermetic, non-process scope as the root lane;
 * otherwise a package command can accidentally collect an integration or smoke suite.
 */
