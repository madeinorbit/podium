...
describe('resolvePlan — help (#18)', () => {
  ...
  it('passthrough subcommands keep their own --help', () => {
  ...
  it('usageText names the commands and the takeover flag', () => {
    const text = usageText()
    for (const word of ['podium all', 'server', 'daemon', 'setup', '--takeover', 'status', 'stop'])
