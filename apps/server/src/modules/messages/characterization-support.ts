...
export interface HarnessOptions {
  ...
  /** Whether the target is an agent session taking the driver path. Kept
  ...
  isAgentDriven?: MessageDeliveryDeps['isAgentDriven']
...
export async function mailHarness(opts?: HarnessOptions): Promise<MailHarness> {
  ...
  const svc = new MessageDeliveryService({
    ...
    ...(opts?.isAgentDriven ? { isAgentDriven: opts.isAgentDriven } : {}),
