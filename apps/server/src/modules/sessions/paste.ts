 ...
 * until W4 retires the server's copy there are two places that put caller text
 * inside a bracketed paste. A boundary applied at only one of them is a boundary
