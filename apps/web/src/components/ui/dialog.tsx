...
function DialogContent({
  ...
  /** Let a consumer provide its own layout inside a viewport-sized popup.
   *  This keeps the shared centering and transition utilities off that popup
   *  instead of asking downstream CSS to override them. */
