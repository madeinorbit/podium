      ...
      <div className="flex-1 overflow-y-auto pb-3">
        ...
        {(workItems.attention.length > 0 ||
          ...
          <div className="min-w-0 border-b border-border">
            {/* NEEDS YOUR ATTENTION — collapsible, default expanded */}
            {workItems.attention.length > 0 && (
              <CollapsibleSection
...
function PanelRow({
  ...
  return (
    <div className="group flex min-w-0 items-center gap-1">
      ...
      {/* On attention rows the pin reveals on hover (snooze owns the always-on
          slot); elsewhere it stays visible to carry the pinned state. */}
      <Button
        variant="ghost"
        size="icon-sm"
        className={cn(
