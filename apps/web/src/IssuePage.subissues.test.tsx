...
const PARENT = makeIssue({ id: 'p', repoPath: '/r', seq: 1, title: 'Epic', childCount: 2, childDoneCount: 0 })
const CHILD_LIVE = makeIssue({ id: 'c-live', repoPath: '/r', seq: 2, title: 'Live child', parentId: 'p' })
...
describe('IssuePage sub-issue list (#133)', () => {
  it('keeps an archived child visible under the parent, marked archived', () => {
    render(<IssuePage issue={PARENT} orderedIds={[PARENT.id]} onBack={vi.fn()} onNavigate={vi.fn()} />)
