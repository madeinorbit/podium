...
export function MissionGauge({
  ...
  return (
    ...
    >
      <span
        className="relative flex h-[22px] min-w-0 flex-1 items-center gap-[2px] overflow-hidden rounded-lg bg-secondary/70 p-[2px] shadow-[inset_0_1px_2px_var(--carve-drop)]"
