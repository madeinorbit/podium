    ...
    >
      <div className="offer-fold-summary">
        <button
          ...
          aria-controls={`offer-detail-${offer.createdAt}`}
      ...
      <div
        id={`offer-detail-${offer.createdAt}`}
        data-testid="offer-detail"
        aria-hidden={!expanded}
        inert={!expanded}
        className="offer-fold-detail"
      >
        <div className="offer-fold-detail-clip">
          <div className="offer-fold-detail-body">
            ...
            {pendingAction ? (
              <div
                className="offer-feedback mt-2 flex flex-col gap-1.5"
                data-testid="offer-feedback"
              >
                <textarea
