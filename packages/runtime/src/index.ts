 ...
 * @podium/runtime
 *
 * Node-runtime plumbing shared across Podium apps (config, sqlite shims, git
 * identity, connectivity, auth-store, …) — NOT the domain model. Entity types
 * and pure business logic live in @podium/domain instead. Consumed as
