...
export * from './strategies/default-registry'
...
// Shipped test doubles: the gateway (POD-317), the daemon dialer (POD-327) and a
// future node binding all drive the real strategies through the same fakes.
