...
export const CONTROL_PLANE_CLASS = {
  ...
  dirOpRequest: 'control.command',
  githubCliRequest: 'control.command',
  input: 'control.command',
  resize: 'control.command',
  ...
  sessionOpenUrlCallback: 'control.command',
  sessionOpenUrlDismiss: 'control.command',
  serverTransferPrepareRequest: 'control.command',
  serverTransferChunkRequest: 'control.command',
...
export const DAEMON_PLANE_CLASS = {
  ...
  machineHarnessVersion: 'control.command',
  ...
  dirOpResult: 'control.command',
  githubCliResult: 'control.command',
