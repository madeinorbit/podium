...
export const WIRE_FIXTURES: WireFixture[] = [
  ...
  // ---- server transfer target RPC (POD-1748) ----
  {
    name: 'frame.serverTransferPrepareRequest',
    schema: ControlMessage,
    value: {
      type: 'serverTransferPrepareRequest',
      requestId: 'st-prepare-1',
  ...
  {
    name: 'frame.serverTransferChunkRequest',
    schema: ControlMessage,
    value: {
      type: 'serverTransferChunkRequest',
      requestId: 'st-chunk-1',
      transferId: '00000000-0000-4000-8000-000000000001',
      manifestDigest: 'b'.repeat(64),
      path: 'podium.db',
      offset: 0,
  ...
  {
    name: 'frame.serverTransferValidateRequest',
    schema: ControlMessage,
    value: {
      type: 'serverTransferValidateRequest',
      requestId: 'st-validate-1',
      transferId: '00000000-0000-4000-8000-000000000001',
      manifestDigest: 'b'.repeat(64),
    },
  },
  {
    name: 'frame.serverTransferPromoteRequest',
    schema: ControlMessage,
    value: {
      type: 'serverTransferPromoteRequest',
      requestId: 'st-promote-1',
      transferId: '00000000-0000-4000-8000-000000000001',
      manifestDigest: 'b'.repeat(64),
  ...
  {
    name: 'frame.serverTransferAbortRequest',
    schema: ControlMessage,
    value: {
      type: 'serverTransferAbortRequest',
      requestId: 'st-abort-1',
      transferId: '00000000-0000-4000-8000-000000000001',
  ...
  {
    name: 'frame.serverTransferResult.full',
    schema: DaemonMessage,
    value: {
  ...
  {
    name: 'frame.serverTransferResult.minimal',
    schema: DaemonMessage,
    value: {
      type: 'serverTransferResult',
      requestId: 'st-status-idle',
      operation: 'status',
      ok: true,
      state: 'idle',
    },
