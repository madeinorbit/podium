...
export const DELEGATION_RULE =
  ...
  '(2) NAMING — give it its job AND tell it to title itself for that job (`podium session title "Spec author"`), so the human\'s board reads like a team; you cannot name it for it. ' +
