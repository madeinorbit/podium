 ...
 * (spec §4). This module keeps only the generic reducers — cursor comparison,
 * event folding, the classifier engine — re-homed unchanged from
 * `agent-state/{causal,reducer,transcript-classifier}.ts`, and never names a
 * harness: every consumer passes per-harness rules in and reads verdicts out.
 * Other driver families import the same pure folding rather than growing a
 * second reducer that would drift from it.
 */
// ---------------------------------------------------------------------------
// From agent-state/causal.ts (POD-4472): unchanged, re-homed.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// From agent-state/reducer.ts (POD-4472): unchanged, re-homed.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// From agent-state/transcript-classifier.ts (POD-4472): unchanged, re-homed.
// ---------------------------------------------------------------------------
