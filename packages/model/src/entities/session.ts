 ...
 * encoding today's wire carries (POD-304). The flags are spread at their
 * historical key position — LAST — so the encoding stays byte-identical and
 * `wire-golden.json` proves it rather than a comment claiming it.
 */
