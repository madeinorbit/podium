...
/** Desired services on a fleet machine. Availability is observed independently;
 * neither enrollment nor historical component data proves a live daemon. */
...
export const MachineWire = z.object({
  ...
  /** Whether this machine was paired as a Podium-managed host. */ podiumManaged: z
    .boolean()
    .optional(),
  /** SEE: compatibility projection of desired assignment; never attachment evidence. */
